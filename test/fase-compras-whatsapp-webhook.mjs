...
async function waitFor(fn){const end=Date.now()+5000;while(Date.now()<end){if(await fn())return;await new Promise(r=>setTimeout(r,50))}throw Error('No llegó el resultado esperado. '+srv.obtenerSalida().slice(-1500))}
try {
