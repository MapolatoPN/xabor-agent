...
## 19. Contexto operativo: el restaurante trabajará solo con Xabor — 22 de septiembre de 2026

Mapolato Obispado dejó de usar Wansoft, un sistema externo e independiente que
nunca formó parte de Xabor ni estuvo conectado a él. Desde esta fecha, el
restaurante trabajará únicamente con **Xabor como punto de venta y fuente de
verdad** para:
...
No hubo una migración técnica, desconexión ni cambio de integración entre los
dos productos. La decisión operativa consiste en dejar de usar el otro punto de
venta en el negocio. Las referencias a Wansoft que existen en este repositorio
son comparaciones de funciones y documentos del periodo en que se evaluaba que
Xabor cubriera la operación del restaurante.

Como Xabor sostendrá la operación diaria, la impresión, visibilidad de pedidos,
caja, pagos y recuperación después de reinicios son funciones críticas. Una
degradación en esos componentes debe tratarse como incidente de producción y
conservar el pedido dentro de Xabor hasta resolverla.
